...
"[project]/src/components/hero/AnimatedGrid.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoadmapSection.useEffect": ()=>{
            ...
            const buildPhaseTimeline = {
                "RoadmapSection.useEffect.buildPhaseTimeline": (phaseIndex)=>{
                    ...
                    const timeline = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$animejs$2f$dist$2f$modules$2f$timeline$2f$timeline$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createTimeline"])({
                        autoplay: false
                    });
            ...
            }["RoadmapSection.useEffect.buildPhaseTimeline"];
            ...
            const triggerObserver = new IntersectionObserver({
                "RoadmapSection.useEffect": (entries)=>{
                    entries.forEach({
                        "RoadmapSection.useEffect": (entry)=>entry.target.classList.toggle('is-in-view', entry.isIntersecting)
                    }["RoadmapSection.useEffect"]);
                }
            }["RoadmapSection.useEffect"], {
            ...
            triggers.forEach({
                "RoadmapSection.useEffect": (trigger)=>triggerObserver.observe(trigger)
            }["RoadmapSection.useEffect"]);
            let frame = 0;
            let previousStep = -1;
            let previousPhase = -1;
            const updateScene = {
                "RoadmapSection.useEffect.updateScene": ()=>{
                    frame = 0;
                    ...
                    if (!reduceMotion) {
                        ...
                        highlights.forEach({
                            "RoadmapSection.useEffect.updateScene": (highlight, index)=>{
            ...
            return ({
                "RoadmapSection.useEffect": ()=>{
                    ...
                    timelines.forEach({
                        "RoadmapSection.useEffect": (timeline)=>timeline.revert()
                    }["RoadmapSection.useEffect"]);
                }
            })["RoadmapSection.useEffect"];
        }
...
_s(RoadmapSection, "827L1nBLQuuW3eZOe2ifrNGo0NA=");
_c = RoadmapSection;
var _c;
...
//# sourceMappingURL=src_0gf51mq._.js.map